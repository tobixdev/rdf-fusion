...
pub fn dispatch_quaternary<TUdf>(
    args: &[ColumnarValue],
    number_of_rows: usize,
) -> DFResult<ColumnarValue>
where
    TUdf: EncScalarQuaternaryUdf,
{
    if args.len() != 4 {
    ...
    for i in 0..number_of_rows {
        ...
        let arg3 = TUdf::Arg3::from_enc_array(arg3_arr, i);

        match (arg0, arg1, arg2, arg3) {
            (Ok(arg0), Ok(arg1), Ok(arg2), Ok(arg3)) => {
                TUdf::evaluate(&mut collector, &arg0, &arg1, &arg2, &arg3)?
            }
