...
make_binary_rdf_udf!(LessOrEqualRdfOp, EncLessOrEqual, ENC_LESS_OR_EQUAL, "enc_less_or_equal");

// Conversion

make_unary_rdf_udf!(AsBooleanRdfOp, EncAsBoolean, ENC_AS_BOOLEAN, "enc_as_boolean");
make_unary_rdf_udf!(AsDecimalRdfOp, EncAsDecimal, ENC_AS_DECIMAL, "enc_as_decimal");
...
make_unary_rdf_udf!(AsIntegerRdfOp, EncAsInteger, ENC_AS_INTEGER, "enc_as_integer");
...
make_unary_rdf_udf!(UnaryMinusRdfOp, EncUnaryMinus, ENC_UNARY_MINUS, "enc_unary_minus");
make_unary_rdf_udf!(UnaryPlusRdfOp, EncUnaryPlus, ENC_UNARY_PLUS, "enc_unary_plus");
...
make_unary_rdf_udf!(IsLiteralRdfOp, EncIsLiteral, ENC_IS_LITERAL, "enc_is_literal");
make_unary_rdf_udf!(IsNumericRdfOp, EncIsNumeric, ENC_IS_NUMERIC, "enc_is_numeric");
