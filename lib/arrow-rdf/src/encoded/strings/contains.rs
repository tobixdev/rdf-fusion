...
impl EncScalarBinaryUdf for EncContains {
    ...
    fn evaluate(
        ...
        let result = arg_lhs.0.contains(arg_rhs.0);
...
impl ScalarUDFImpl for EncContains {
    ...
    fn invoke_batch(
        ...
        dispatch_binary::<EncContains>(args, number_rows)
    }
}
