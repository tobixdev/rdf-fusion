...
pub static ENC_QUAD_SCHEMA: LazyLock<SchemaRef> = LazyLock::new(|| {
    SchemaRef::new(Schema::new(vec![
        ...
        Field::new(COL_SUBJECT, RdfValueEncoding::data_type(), true),
        Field::new(COL_PREDICATE, RdfValueEncoding::data_type(), true),
        Field::new(COL_OBJECT, RdfValueEncoding::data_type(), true),
    ]))
});
