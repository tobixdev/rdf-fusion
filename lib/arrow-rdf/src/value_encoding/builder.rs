...
impl Default for EncRdfTermBuilder {
    fn default() -> Self {
        Self {
            ...
            string_builder: StructBuilder::from_fields(RdfValueEncoding::string_fields(), 0),
            ...
            date_time_builder: StructBuilder::from_fields(RdfValueEncoding::timestamp_fields(), 0),
            time_builder: StructBuilder::from_fields(RdfValueEncoding::timestamp_fields(), 0),
            date_builder: StructBuilder::from_fields(RdfValueEncoding::timestamp_fields(), 0),
            duration_builder: StructBuilder::from_fields(RdfValueEncoding::duration_fields(), 0),
            typed_literal_builder: StructBuilder::from_fields(
                RdfValueEncoding::typed_literal_fields(),
                0,
            ),
...
impl EncRdfTermBuilder {
    ...
    pub fn append_boolean(&mut self, value: bool) -> AResult<()> {
        self.append_type_id_and_offset(RdfValueEncodingField::Boolean, self.boolean_builder.len())?;
    ...
    pub fn append_string(&mut self, value: &str, language: Option<&str>) -> AResult<()> {
        ...
        self.append_type_id_and_offset(RdfValueEncodingField::String, self.string_builder.len())?;
    ...
    pub fn append_time(&mut self, value: Time) -> AResult<()> {
        self.append_type_id_and_offset(RdfValueEncodingField::Time, self.time_builder.len())?;
        append_timestamp(&mut self.time_builder, value.timestamp());
        Ok(())
    }

    pub fn append_date(&mut self, value: Date) -> AResult<()> {
        self.append_type_id_and_offset(RdfValueEncodingField::Date, self.date_builder.len())?;
        append_timestamp(&mut self.date_builder, value.timestamp());
        Ok(())
    }

    pub fn append_int(&mut self, int: Int) -> AResult<()> {
        self.append_type_id_and_offset(RdfValueEncodingField::Int, self.int32_builder.len())?;
        self.int32_builder.append_value(int.into());
        Ok(())
    }

    pub fn append_integer(&mut self, integer: Integer) -> AResult<()> {
        self.append_type_id_and_offset(RdfValueEncodingField::Integer, self.integer_builder.len())?;
        self.integer_builder.append_value(integer.into());
        Ok(())
    }

    pub fn append_float(&mut self, value: Float) -> AResult<()> {
        self.append_type_id_and_offset(RdfValueEncodingField::Float, self.float_builder.len())?;
        self.float_builder.append_value(value.into());
        Ok(())
    }

    pub fn append_double(&mut self, value: Double) -> AResult<()> {
        self.append_type_id_and_offset(RdfValueEncodingField::Double, self.double_builder.len())?;
        self.double_builder.append_value(value.into());
        Ok(())
    }

    pub fn append_decimal(&mut self, value: Decimal) -> AResult<()> {
        self.append_type_id_and_offset(RdfValueEncodingField::Decimal, self.decimal_builder.len())?;
    ...
    pub fn append_null(&mut self) -> AResult<()> {
        self.append_type_id_and_offset(RdfValueEncodingField::Null, self.null_builder.len())?;
