use crate::value_encoding::dispatch::dispatch_binary;
    ...
    fn default() -> Self {
        Self {
            signature: Signature::new(
                TypeSignature::Exact(vec![RdfValueEncoding::data_type(); 2]),
        ...
        match result {
            ColumnarValue::Array(array) => {
                ...
                Ok(ColumnarValue::Array(Arc::clone(
                    array.child(RdfValueEncodingField::Boolean.type_id()),
                )))
            }
