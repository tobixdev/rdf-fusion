use crate::typed_family::error::TypedFamilyPureResultError;
...
/// A struct representing a pure result of a typed family operation. It has already been validated
/// that the contained array is conformant to the typed family.
///
/// # Null Handling
///
/// The array that contains the result *can* contain null values. This is contrary to the
/// requirement that no typed family (see [`TypedFamily`]) is allowed to store null values. Null
